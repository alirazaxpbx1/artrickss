...
while true; do
    ...
    echo -e "${CYAN}│${NC}              ${BOLD}${CYAN}✦  A R T R I C K S  ✦${NC}                     ${CYAN}│${NC}"
    echo -e "${CYAN}│${NC}              ${BOLD}${YELLOW}V P S   C O N T R O L${NC}                     ${CYAN}│${NC}"
    echo -e "${CYAN}│${NC}                                                              ${CYAN}│${NC}"
    echo -e "${CYAN}├──────────────────────────────────────────────────────────────┤${NC}"
    echo -e "${CYAN}│${NC}  ${GREEN}●${NC} SYSTEM STATUS   : ${GREEN}${BOLD}ONLINE${NC}                         ${CYAN}│${NC}"
    echo -e "${CYAN}│${NC}  ${BLUE}◆${NC} DOMAIN         : ${YELLOW}${CURRENT_DOM:-Not Configured}${NC}                    ${CYAN}│${NC}"
    echo -e "${CYAN}│${NC}  ${BLUE}◆${NC} ACTIVE PATH     : ${YELLOW}${CUSTOM_PATH:-/ARTricks}${NC}                         ${CYAN}│${NC}"
    echo -e "${CYAN}├──────────────────────────────────────────────────────────────┤${NC}"
    echo -e "${CYAN}│${NC}                                                              ${CYAN}│${NC}"
    echo -e "${CYAN}│${NC}   ${GREEN}[01]${NC}  ⚙  SYSTEM INSTALL       ${GREEN}[06]${NC}  💬  SSH BANNER       ${CYAN}│${NC}"
    echo -e "${CYAN}│${NC}   ${GREEN}[02]${NC}  🌐  DOMAIN MANAGER      ${GREEN}[07]${NC}  🔗  CONNECTION MGR   ${CYAN}│${NC}"
    echo -e "${CYAN}│${NC}   ${GREEN}[03]${NC}  🔐  SSL CERTIFICATE      ${GREEN}[08]${NC}  🤖  TELEGRAM BOT     ${CYAN}│${NC}"
    echo -e "${CYAN}│${NC}   ${GREEN}[04]${NC}  👤  ACCOUNT MANAGER      ${RED}[09]${NC}  🗑  UNINSTALL         ${CYAN}│${NC}"
    echo -e "${CYAN}│${NC}   ${GREEN}[05]${NC}  📊  STATUS & PORTS       ${YELLOW}[00]${NC}  ←  EXIT              ${CYAN}│${NC}"
    echo -e "${CYAN}│${NC}                                                              ${CYAN}│${NC}"
    echo -e "${CYAN}├──────────────────────────────────────────────────────────────┤${NC}"
    echo -e "${CYAN}│${NC}       ${BOLD}${YELLOW}➜  SELECT AN OPTION [01-09 / 00]${NC}                      ${CYAN}│${NC}"
    echo -e "${CYAN}╰──────────────────────────────────────────────────────────────╯${NC}"
